        ...
        body: text = new RichText(
          text: new TextSpan(
              ...
              children: <TextSpan>[
                ...
                new TextSpan(
                    text:
                        'The entire communication with the applicatoion is electronic. Every time '
                ...
                new TextSpan(
                    text:
                        'By using this application, you agree that the laws of the \''
                ...
                new TextSpan(
                    text:
                        'Any dispute related in any way to your using of this application '
                ...
                new TextSpan(
                    text: '   Comments, Reviews, and Emails\n',
                    style: new TextStyle(
                        color: bforBlack,
                        fontSize: 12.0,
                        fontWeight: FontWeight.bold)),
                new TextSpan(
                    text:
                        'Confucious say: don\'t making the shit posting on this '
                        'appricashion. \n\n',
                    style: new TextStyle(
                      color: bforBlack,
                      fontSize: 5.0,
                ...
                new TextSpan(
                    text:
                        'If you are an owner of an account on this application, you are '
